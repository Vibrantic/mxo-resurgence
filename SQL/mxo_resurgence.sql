...
-- Dumping database structure for mxo_resurgence
CREATE DATABASE IF NOT EXISTS `mxo_resurgence` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `mxo_resurgence`;

-- Dumping structure for table hds.buddylist
...
-- Dumping data for table hds.buddylist: ~0 rows (approximately)
...
-- Dumping structure for table hds.characters
...
-- Dumping data for table hds.characters: 6 rows
...
INSERT INTO `characters` (`charId`, `userId`, `worldId`, `status`, `handle`, `firstName`, `lastName`, `background`, `x`, `y`, `z`, `rotation`, `healthC`, `healthM`, `innerStrC`, `innerStrM`, `level`, `profession`, `alignment`, `pvpflag`, `exp`, `cash`, `repMero`, `repMachine`, `repNiobe`, `repEPN`, `repCYPH`, `repGM`, `repZion`, `district`, `districtId`, `factionId`, `crewId`, `is_deleted`, `is_online`, `created`) VALUES
	(2, 28, 1, 0, 'TheNeo', 'Mr', 'Neo', 'Has all shit loaded for Development! YEAH!', 22838.2, 495, -869.721, 116, 500, 500, 200, 200, 50, 2, 0, 0, 314630206, 987674321, 0, 0, 0, 0, 0, 0, 100, 'slums', 1, 0, 1, 0, 0, '0000-00-00 00:00:00'),
/*!40000 ALTER TABLE `characters` ENABLE KEYS */;

-- Dumping structure for table hds.char_abilities
...
-- Dumping data for table hds.char_abilities: ~43 rows (approximately)
...
-- Dumping structure for table hds.char_hardlines
...
-- Dumping data for table hds.char_hardlines: ~0 rows (approximately)
/*!40000 ALTER TABLE `char_hardlines` DISABLE KEYS */;
/*!40000 ALTER TABLE `char_hardlines` ENABLE KEYS */;

-- Dumping structure for table hds.crews
...
-- Dumping data for table hds.crews: ~0 rows (approximately)
/*!40000 ALTER TABLE `crews` DISABLE KEYS */;
INSERT INTO `crews` (`id`, `crew_name`, `master_player_handle`, `faction_id`, `created_at`, `deleted_at`) VALUES
	(1, 'Reservoir Dogs', 'TheNeo', 0, '2017-06-09 05:30:50', '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `crews` ENABLE KEYS */;

-- Dumping structure for table hds.crew_members
...
-- Dumping data for table hds.crew_members: ~2 rows (approximately)
/*!40000 ALTER TABLE `crew_members` DISABLE KEYS */;
INSERT INTO `crew_members` (`id`, `crew_id`, `char_id`, `is_master`, `created_at`) VALUES
	(1, 1, 2, 1, '2017-06-09 05:32:49'),
	(2, 1, 3, 0, '2017-06-09 05:32:55');
/*!40000 ALTER TABLE `crew_members` ENABLE KEYS */;

-- Dumping structure for table hds.data_hardlines
...
-- Dumping data for table hds.data_hardlines: 135 rows
...
-- Dumping structure for table hds.districts
...
-- Dumping data for table hds.districts: 25 rows
...
-- Dumping structure for table hds.factions
...
-- Dumping data for table hds.factions: ~0 rows (approximately)
/*!40000 ALTER TABLE `factions` DISABLE KEYS */;
/*!40000 ALTER TABLE `factions` ENABLE KEYS */;

-- Dumping structure for table hds.inventory
...
-- Dumping data for table hds.inventory: 93 rows
...
INSERT INTO `inventory` (`invId`, `charId`, `goid`, `slot`, `count`, `purity`, `updated`, `created`) VALUES
	...
	(84, 2, 39766, 101, 0, 1, '0000-00-00 00:00:00', '2017-03-03 11:35:31'),
	(85, 2, 39766, 4, 0, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(163, 2, 38146, 12, 0, 0, '0000-00-00 00:00:00', '2017-03-11 00:26:59'),
...
-- Dumping structure for table hds.locations
...
-- Dumping data for table hds.locations: 45 rows
...
-- Dumping structure for table hds.marketplace
...
-- Dumping data for table hds.marketplace: ~0 rows (approximately)
/*!40000 ALTER TABLE `marketplace` DISABLE KEYS */;
/*!40000 ALTER TABLE `marketplace` ENABLE KEYS */;

-- Dumping structure for table hds.rsivalues
...
-- Dumping data for table hds.rsivalues: 8 rows
...
-- Dumping data for table hds.users: 3 rows
