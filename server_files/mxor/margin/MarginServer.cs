...
namespace mxor.margin
{
    public class MarginServer
    {
        ...
        public void StopServer()
        {
            ...
            {
                MarginClient temp =  clientList[i];
                temp.forceClose();
            }
        ...
        public void SendUDPSessionReply(uint charID)
        {
        ...
        public bool IsAnotherClientActive(uint charId)
        {
            bool isActive = false;
        ...
        public void RemoveClientsByCharId(uint charId)
        {
